    ...
    <div>
        ...
        <table cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <?php
                 $inboxquery = "SELECT * FROM comments WHERE toid='".$_SESSION['userid']."' && toisdesigner='".$_SESSION['ifisdesigner']."' && ispm='1' ORDER BY id DESC";
                 $msgs = 0;
                 $n = 0;
                    if ($inboxresult = mysql_query($inboxquery, $link)) {
